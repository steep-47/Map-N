...
try {
    ...
    await import('./Map-N.js?v=1.4.7');
    await import('./canonicalizer.js?v=1.4.7');
    await import('./scene-scanner.js?v=1.4.7');
    await import('./strict-entity-resolver.js?v=1.4.7');
    await import('./hierarchy-resolver.js?v=1.4.7');
    await import('./presence-resolver.js?v=1.4.7');
    await import('./theme-manager.js?v=1.4.7');
    await import('./data-manager.js?v=1.4.7');
